...
PWD="C:\\Users\sutor\OneDrive\ThinkPad_working\Sutor\Science\Arabidopsis_gyrase\Sequencing_results\Mito_RNA_Seq_Garcia_2021\WIG\BK010421.1\\"

#Dictionary of replicas 
#'Replica name' : 'Path to wig file'
Dict_of_replicas={'MtRNA_Seq_1_ERR1665215' : PWD + "BK010421.1_MtRNA_Seq_1_ERR1665215.wig",
                  'MtRNA_Seq_2_ERR1665219' : PWD + "BK010421.1_MtRNA_Seq_2_ERR1665219.wig",
                  'MtRNA_Seq_3_ERR1665220' : PWD + "BK010421.1_MtRNA_Seq_3_ERR1665220.wig",
                  }

#ID or short description of the track (will be the name of a track in IGV).
Output_name='BK010421.1_MtRNA_Seq_av'
#ID of chromosome (for w3110_Mu_SGS: NC_007779.1_w3110_Mu)
Chromosome_name='BK010421.1'
