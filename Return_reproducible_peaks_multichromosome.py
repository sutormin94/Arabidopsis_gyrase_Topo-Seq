...
PWD_peaks="/home/niagara/Storage/D_Sutormin/Hi_C_and_Seqs_2/A_Polkhovskiy/NUMT_masked/Peak_calling/ChIP/"
Set_name="TopoIV Topo-Seq, ChIP-Seq, and NorfIP"
Peaks_data={'1' : PWD_peaks + "ChIP1_peaks.narrowPeak",
            '2' : PWD_peaks + "ChIP2_peaks.narrowPeak",
            }


#Path to the reference genome (e.g. E_coli_w3110_G_Mu.fasta).
Genome="/home/niagara/Storage/D_Sutormin/Hi_C_and_Seqs_2/A_Polkhovskiy/Ref_genome/GCA_000001735.2_TAIR10.1_genomic_NUMT_masked.fna"
#Threshold for reproducible peaks calling (must not exceed number of replicas).
Threshold=int(2)
Path_out="/home/niagara/Storage/D_Sutormin/Hi_C_and_Seqs_2/A_Polkhovskiy/NUMT_masked/Peak_calling/ChIP/Analysis"
#Output name.
Output_name="TAIR_ChIP"
...
def Wrapper(reps_dict, set_name, thr, genome_path, outpath, pathout_name):
    ...
    #Reads genome fasta.
    chromosome_dict=genome_seq(genome_path)
    
    #Reads replicas data.
    rep_data={}
    for name, rep_path in reps_dict.items():
        rep_data[name]=read_peaks(rep_path)
